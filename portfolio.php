<?php error_reporting(0);  if(isset($_GET['err'])) { ?>
<a class="biss-btn biss-btn-primary width-100 align-left" href="#"><i class="fa fa-futbol-o"></i> reCAPTCHA Error !</a>
<?php } ?>
...
<div class="row">
<div class="col-xs-12">
						<form class="comment-form floating-form" id="portfolioform" method="post" name="getquote" data-toggle="validator" action="cap-mail1.php">
...
<div class="form-elem form-elem-full" style="width: 88%; overflow: hidden;">
...
<div class="g-recaptcha" data-sitekey="6LdHXQgTAAAAAMqIp3D9kDv9CGeaIce6UUttROKU" style="width: 88%; overflow: hidden;"></div>
                        ...
                        <p class="section-subtitle">Blaze</p>
							...
							<h2 class="section-title margin-bottom-10">Projects</h2>
								...
								<div class="filters align-left">
									...
									<span data-value="mysql">mysql</span>
